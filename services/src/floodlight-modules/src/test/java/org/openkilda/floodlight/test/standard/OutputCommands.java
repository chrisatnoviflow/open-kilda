...
public interface OutputCommands {
    ...
    default OFFlowAdd installVerificationBroadcastRuleWithRoundTripLatency() {
        Match match = ofFactory.buildMatch()
                .setExact(MatchField.ETH_DST, MacAddress.of(VERIFICATION_BCAST_PACKET_DST))
                .build();
        return ofFactory.buildFlowAdd()
    ...
    default OFFlowAdd installVerificationBroadcastRuleWithoutRoundTripLatency(DatapathId defaultDpId) {
        Match match = ofFactory.buildMatch()
                .setExact(MatchField.ETH_DST, MacAddress.of(VERIFICATION_BCAST_PACKET_DST))
                .build();
        return ofFactory.buildFlowAdd()
