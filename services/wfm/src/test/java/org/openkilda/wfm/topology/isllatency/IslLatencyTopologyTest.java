...
public class IslLatencyTopologyTest extends AbstractStormTest {
    ...
    public void oneWayLatencyNonNoviflowMetricTest() throws Exception {
        IslOneWayLatency islOneWayLatency =
                new IslOneWayLatency(SWITCH_ID_1, PORT_1, SWITCH_ID_2, PORT_2, FORWARD_LATENCY, PACKET_ID, false);
    ...
    public void oneWayLatencyNoviflowMetricTest() throws Exception {
        IslOneWayLatency islOneWayLatency =
                new IslOneWayLatency(SWITCH_ID_1, PORT_1, SWITCH_ID_2, PORT_2, FORWARD_LATENCY, PACKET_ID, true);
