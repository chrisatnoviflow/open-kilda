...
public class FlowRerouteFsm
    ...
    private FlowResources newResources;
    private PathId newForwardPath;
    private PathId newReversePath;

    private FlowStatus oldStatus;
    private FlowResources oldResources;
    private PathId oldForwardPath;
    private FlowPathStatus oldForwardPathStatus;
    private PathId oldReversePath;
    private FlowPathStatus oldReversePathStatus;
    ...
    private static StateMachineBuilder<FlowRerouteFsm, State, Event, FlowRerouteContext> builder(
        ...
        builder.transitions().from(State.RESOURCES_ALLOCATED)
                ...
                .onEach(Event.TIMEOUT, Event.ERROR, Event.NO_RESOURCES_AVAILABLE);
    ...
    @Override
    protected void afterTransitionCausedException(FlowRerouteFsm.State fromState, FlowRerouteFsm.State toState,
                                                  FlowRerouteFsm.Event event, FlowRerouteContext context) {
        if (fromState == FlowRerouteFsm.State.INITIALIZED || fromState == FlowRerouteFsm.State.FLOW_VALIDATED) {
    ...
    public static FlowRerouteFsm newInstance(FlowRerouteFsm.State state, CommandContext commandContext,
